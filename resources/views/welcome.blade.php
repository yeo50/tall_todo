    ...
    <div class="p-4 w-full h-[calc(100vh-56px)] md:flex">
        <div class="md:hidden">
            <div class="w-28 mx-auto ">
                ...
                <img src="https://fls-9e598cd7-ea13-4804-acad-f10a8c140b60.laravel.cloud/rightArrow.png" alt="arrow"
                    class="block w-fll h-full">
            </div>
            <h1
        ...
        <div class="md:flex-1">
            <img src="https://fls-9e598cd7-ea13-4804-acad-f10a8c140b60.laravel.cloud/to_do_photos/11107577_4668855.svg"
                alt="photo" class="w-full h-[350px] md:block md:w-full md:h-full">
        </div>
        <div class=" md:flex-1 mx-auto flex items-center mt-10 space-y-4">
            ...
            <div class=" mx-auto flex items-center flex-col space-y-4 w-5/6 lg:w-4/6">
                <div class="hidden md:block w-28 mx-auto">
                    <img src="https://fls-9e598cd7-ea13-4804-acad-f10a8c140b60.laravel.cloud/rightArrow.png"
                        alt="arrow" class="block w-fll h-full">
                </div>
                <h1

...
<div>
    <div
        ...
        <div class="w-full h-full">
            ...
            <div wire:loading.remove
                ...
                @if ($deleted_at === null)
                    <span wire:click="$parent.markComplete()"
                    ...
                    <span class="text-gray-800 font-semibold ps-3"> {{ $name }} </span>
                @else
                    <span wire:click="$parent.unmarkComplete()"
                ...
                <span class="text-blue-700 ">
                    @if ($important === 1)
                        <svg wire:click="$parent.markImportant()" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    ...
                    @else
                        <svg wire:click="$parent.markImportant()" xmlns="http://www.w3.org/2000/svg" fill="none"
    ...
    <div class="fixed right-0 bottom-0 bg-white w-96 h-12 ">
        <div class="flex justify-between items-center px-2 py-2 dark:text-black">
            ...
            <span>
                <svg wire:loading.remove @click="deleteConfirm = true" xmlns="http://www.w3.org/2000/svg" fill="none"

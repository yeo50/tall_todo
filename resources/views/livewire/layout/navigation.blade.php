...
}" x-init="if (darkMode) document.documentElement.classList.add('dark')" @shrink.window="open = false" @remove-profile.window="open =false"
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center ms-6">
                ...
                <div class="-me-2 flex items-center sm:hidden">
                    <button @click="open = ! open; if(open) $dispatch('remove-menu')"
